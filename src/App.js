		...
		<div className='wrapper'>
			<header className='header'>
				<a className='header__logo' href='/'>
					<img src="/images/logo.png" alt="sneakers"/>
					<div>
						<h3 className='header__title'>Sneakers</h3>
				...
				<ul className="menu">
					<li className="menu__item">
						<a href="#">
							...
							<span className='menu__price'>1205 руб.</span>
						</a>
					</li>
					<li className="menu__item">
						<a href="#">
			...
			<main>
				<section className='content'>
					...
					<ul className="card__list">
						...
						<li className="card">
							<img width={133} height={112} className="card__img" src="/images/sneakers/2.jpg" alt="Sneakers"/>
							<h5 className='card__text'>Мужские Кроссовки Nike Blazer Mid Suede</h5>
							<div className='card__inner'>
								<div className='card__inner-column'>
									<span>Цена:</span>
						...
						<li className="card">
							<img width={133} height={112} className="card__img" src="/images/sneakers/3.jpg" alt="Sneakers"/>
							<h5 className='card__text'>Мужские Кроссовки Nike Blazer Mid Suede</h5>
							<div className='card__inner'>
								<div className='card__inner-column'>
									<span>Цена:</span>
						...
						<li className="card">
							<img width={133} height={112} className="card__img" src="/images/sneakers/4.jpg" alt="Sneakers"/>
							<h5 className='card__text'>Мужские Кроссовки Nike Blazer Mid Suede</h5>
							<div className='card__inner'>
								<div className='card__inner-column'>
									<span>Цена:</span>
